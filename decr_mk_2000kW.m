%% Design space exploraton: 2000 kW: Decreased Kite mass
...
% Load input file
inputs = loadInputs('inputFile_2000kW_decr_mk.yml');
...
save('outPutFiles/designSpace_2000kW_WA_WL_var_decr_mk.mat', 'designSpace_2000kW_WA_WL_var');

% Load saved design space results
load('outPutFiles/designSpace_2000kW_WA_WL_var_decr_mk.mat');
...
% Save design space results
save('outPutFiles/designSpace_2000kW_WL_sigma_t_var_decr_mk.mat','designSpace_2000kW_WL_sigma_t_var');

% Load the saved design space results
load('outPutFiles/designSpace_2000kW_WL_sigma_t_var_decr_mk.mat');
...
% Save design space results
save('outPutFiles/designSpace_2000kW_WA_AR_var_decr_mk.mat','designSpace_2000kW_WA_AR_var');

% Load the saved design space results
load('outPutFiles/designSpace_2000kW_WA_AR_var_decr_mk.mat');
...
% Save design space results
save('outPutFiles/designSpace_2000kW_WA_crestFactor_var_decr_mk.mat','designSpace_2000kW_WA_crestFactor_var');

% Load the saved design space results
load('outPutFiles/designSpace_2000kW_WA_crestFactor_var_decr_mk.mat');
...
perfInputs = loadInputs('inputFile_2000kW_decr_mk.yml');
...
save('outputFiles/systemData_2000kW_decr_mk.mat');
