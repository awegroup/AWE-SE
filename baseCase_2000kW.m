%% Design space exploraton: 2000 kW Base case
clc; clearvars;
...
% Load input file
inputs = loadInputs('inputFile_2000kW_baseCase.yml');
...
save('outPutFiles/designSpace_2000kW_WA_WL_var_baseCase.mat', 'designSpace_2000kW_WA_WL_var');

% Load saved design space results
load('outPutFiles/designSpace_2000kW_WA_WL_var_baseCase.mat');
...
% Save design space results
save('outPutFiles/designSpace_2000kW_WL_sigma_t_var_baseCase.mat','designSpace_2000kW_WL_sigma_t_var');

% Load the saved design space results
load('outPutFiles/designSpace_2000kW_WL_sigma_t_var_baseCase.mat');
...
% Save design space results
save('outPutFiles/designSpace_2000kW_WA_AR_var_baseCase.mat','designSpace_2000kW_WA_AR_var');

% Load the saved design space results
load('outPutFiles/designSpace_2000kW_WA_AR_var_baseCase.mat');
...
% Save design space results
save('outPutFiles/designSpace_2000kW_WA_crestFactor_var_baseCase.mat','designSpace_2000kW_WA_crestFactor_var');

% Load the saved design space results
load('outPutFiles/designSpace_2000kW_WA_crestFactor_var_baseCase.mat');
...
perfInputs = loadInputs('inputFile_2000kW_baseCase.yml');
...
save('outputFiles/systemData_2000kW_baseCase.mat');
...
% 
% % Save design space results
% save('outPutFiles/designSpace_2000kW_crestFactor_P_rated_var_baseCase.mat','designSpace_2000kW_crestFactor_P_rated_var');
% 
% % Load the saved design space results
% load('outPutFiles/designSpace_2000kW_crestFactor_P_rated_var_baseCase.mat');
% 
% % Plot
