...
P_rated_values   = [75e3, 100e3, 125e3]; % W
...
% crestFactor_values = [1.8, 2]; % -
% 
% % Evaluate design space
% [designSpace_100kW_WA_crestFactor_var] = wingArea_crestFactor_variation(WA_values, crestFactor_values, inputs);
% 
% % Save design space results
% save('outPutFiles/designSpace_100kW_WA_crestFactor_var.mat','designSpace_100kW_WA_crestFactor_var');
% 
% % Load the saved design space results
% load('outPutFiles/designSpace_100kW_WA_crestFactor_var.mat');
% 
% % Plot
