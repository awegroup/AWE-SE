%% Design space exploraton: 1000 kW: Decreased Kite mass
...
% Load input file
inputs = loadInputs('inputFile_1000kW_decr_mk.yml');

% Define range for wing area 
WA_values = [110, 120, 130]; % m^2
...
save('outPutFiles/designSpace_1000kW_WA_WL_var_decr_mk.mat', 'designSpace_1000kW_WA_WL_var');

% Load saved design space results
load('outPutFiles/designSpace_1000kW_WA_WL_var_decr_mk.mat');
...
% Save design space results
save('outPutFiles/designSpace_1000kW_WL_sigma_t_var_decr_mk.mat','designSpace_1000kW_WL_sigma_t_var');

% Load the saved design space results
load('outPutFiles/designSpace_1000kW_WL_sigma_t_var_decr_mk.mat');
...
% Save design space results
save('outPutFiles/designSpace_1000kW_WA_AR_var_decr_mk.mat','designSpace_1000kW_WA_AR_var');

% Load the saved design space results
load('outPutFiles/designSpace_1000kW_WA_AR_var_decr_mk.mat');
...
% Save design space results
save('outPutFiles/designSpace_1000kW_WA_crestFactor_var_decr_mk.mat','designSpace_1000kW_WA_crestFactor_var');

% Load the saved design space results
load('outPutFiles/designSpace_1000kW_WA_crestFactor_var_decr_mk.mat');
...
clearvars
perfInputs = loadInputs('inputFile_1000kW_decr_mk.yml');
...
save('outputFiles/systemData_1000kW_decr_mk.mat');
