%% Design space exploraton: 500 kW 0 Wind Shear
...
% Load input file
inputs = loadInputs('inputFile_500kW_0_windShear.yml');
...
save('outPutFiles/designSpace_500kW_WA_WL_var_0_windShear.mat', 'designSpace_500kW_WA_WL_var');

% Load saved design space results
load('outPutFiles/designSpace_500kW_WA_WL_var_0_windShear.mat');
...
% Save design space results
save('outPutFiles/designSpace_500kW_WL_sigma_t_var_0_windShear.mat','designSpace_500kW_WL_sigma_t_var');

% Load the saved design space results
load('outPutFiles/designSpace_500kW_WL_sigma_t_var_0_windShear.mat');
...
% Save design space results
save('outPutFiles/designSpace_500kW_WA_AR_var_0_windShear.mat','designSpace_500kW_WA_AR_var');

% Load the saved design space results
load('outPutFiles/designSpace_500kW_WA_AR_var_0_windShear.mat');
...
% Save design space results
save('outPutFiles/designSpace_500kW_WA_crestFactor_var_0_windShear.mat','designSpace_500kW_WA_crestFactor_var');

% Load the saved design space results
load('outPutFiles/designSpace_500kW_WA_crestFactor_var_0_windShear.mat');
...
clearvars
perfInputs = loadInputs('inputFile_500kW_0_windShear.yml');
...
save('outputFiles/systemData_500kW_0_windShear.mat');
