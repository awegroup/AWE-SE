%% Design space exploraton: 2000 kW Increased r
...
save('outPutFiles/designSpace_2000kW_WA_WL_var_incr_r.mat', 'designSpace_2000kW_WA_WL_var');

% Load saved design space results
load('outPutFiles/designSpace_2000kW_WA_WL_var_incr_r.mat');
...
% Save design space results
save('outPutFiles/designSpace_2000kW_WL_sigma_t_var_incr_r.mat','designSpace_2000kW_WL_sigma_t_var');

% Load the saved design space results
load('outPutFiles/designSpace_2000kW_WL_sigma_t_var_incr_r.mat');
...
% Save design space results
save('outPutFiles/designSpace_2000kW_WA_AR_var_incr_r.mat','designSpace_2000kW_WA_AR_var');

% Load the saved design space results
load('outPutFiles/designSpace_2000kW_WA_AR_var_incr_r.mat');
...
% Save design space results
save('outPutFiles/designSpace_2000kW_WA_crestFactor_var_incr_r.mat','designSpace_2000kW_WA_crestFactor_var');

% Load the saved design space results
load('outPutFiles/designSpace_2000kW_WA_crestFactor_var_incr_r.mat');
...
save('outputFiles/systemData_2000kW_incr_r.mat');
