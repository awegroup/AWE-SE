%% Design space exploraton: 2000 kW No storage costs
...
% Load input file
inputs = loadInputs('inputFile_2000kW_noStorage.yml');

% Define range for wing area 
WA_values = [140, 150, 160]; % m^2
...
save('outPutFiles/designSpace_2000kW_WA_WL_var_noStorage.mat', 'designSpace_2000kW_WA_WL_var');

% Load saved design space results
load('outPutFiles/designSpace_2000kW_WA_WL_var_noStorage.mat');
...
% Save design space results
save('outPutFiles/designSpace_2000kW_WL_sigma_t_var_noStorage.mat','designSpace_2000kW_WL_sigma_t_var');

% Load the saved design space results
load('outPutFiles/designSpace_2000kW_WL_sigma_t_var_noStorage.mat');
...
% Save design space results
save('outPutFiles/designSpace_2000kW_WA_AR_var_noStorage.mat','designSpace_2000kW_WA_AR_var');

% Load the saved design space results
load('outPutFiles/designSpace_2000kW_WA_AR_var_noStorage.mat');
...
% Save design space results
save('outPutFiles/designSpace_2000kW_WA_crestFactor_var_noStorage.mat','designSpace_2000kW_WA_crestFactor_var');

% Load the saved design space results
load('outPutFiles/designSpace_2000kW_WA_crestFactor_var_noStorage.mat');
...
perfInputs = loadInputs('inputFile_2000kW_noStorage.yml');
...
save('outputFiles/systemData_2000kW_noStorage.mat');
