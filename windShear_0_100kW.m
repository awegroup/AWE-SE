%% Design space exploraton: 100 kW 0 Wind Shear
...
% Load input file
inputs = loadInputs('inputFile_100kW_0_windShear.yml');
...
save('outPutFiles/designSpace_100kW_WA_WL_var_0_windShear.mat', 'designSpace_100kW_WA_WL_var');

% Load saved design space results
load('outPutFiles/designSpace_100kW_WA_WL_var_0_windShear.mat');
...
% Save design space results
save('outPutFiles/designSpace_100kW_WL_sigma_t_var_0_windShear.mat','designSpace_100kW_WL_sigma_t_var');

% Load the saved design space results
load('outPutFiles/designSpace_100kW_WL_sigma_t_var_0_windShear.mat');
...
% Save design space results
save('outPutFiles/designSpace_100kW_WA_AR_var_0_windShear.mat','designSpace_100kW_WA_AR_var');

% Load the saved design space results
load('outPutFiles/designSpace_100kW_WA_AR_var_0_windShear.mat');
...
% Save design space results
save('outPutFiles/designSpace_100kW_WA_crestFactor_var_0_windShear.mat','designSpace_100kW_WA_crestFactor_var');

% Load the saved design space results
load('outPutFiles/designSpace_100kW_WA_crestFactor_var_0_windShear.mat');
...
perfInputs = loadInputs('inputFile_100kW_0_windShear.yml');
...
save('outputFiles/systemData_100kW_0_windShear.mat');
