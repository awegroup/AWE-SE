%% Design space exploraton: 1000 kW 0 Wind Shear and 10m/s wind speed
...
% Load input file
inputs = loadInputs('inputFile_1000kW_high_wind_0_shear.yml');

% Define range for wing area 
WA_values = [100, 110, 120]; % m^2
...
save('outPutFiles/designSpace_1000kW_WA_WL_var_high_wind_0_shear.mat', 'designSpace_1000kW_WA_WL_var');

% Load saved design space results
load('outPutFiles/designSpace_1000kW_WA_WL_var_high_wind_0_shear.mat');
...
% Save design space results
save('outPutFiles/designSpace_1000kW_WL_sigma_t_var_high_wind_0_shear.mat','designSpace_1000kW_WL_sigma_t_var');

% Load the saved design space results
load('outPutFiles/designSpace_1000kW_WL_sigma_t_var_high_wind_0_shear.mat');
...
% Save design space results
save('outPutFiles/designSpace_1000kW_WA_AR_var_high_wind_0_shear.mat','designSpace_1000kW_WA_AR_var');

% Load the saved design space results
load('outPutFiles/designSpace_1000kW_WA_AR_var_high_wind_0_shear.mat');
...
% Save design space results
save('outPutFiles/designSpace_1000kW_WA_crestFactor_var_high_wind_0_shear.mat','designSpace_1000kW_WA_crestFactor_var');

% Load the saved design space results
load('outPutFiles/designSpace_1000kW_WA_crestFactor_var_high_wind_0_shear.mat');
...
clearvars
perfInputs = loadInputs('inputFile_1000kW_high_wind_0_shear.yml');
...
save('outputFiles/systemData_1000kW_high_wind_0_shear.mat');
...
% 
% % Save design space results
% save('outPutFiles/designSpace_1000kW_crestFactor_P_rated_var_high_wind_0_shear.mat','designSpace_1000kW_crestFactor_P_rated_var');
% 
% % Load the saved design space results
% load('outPutFiles/designSpace_1000kW_crestFactor_P_rated_var_high_wind_0_shear.mat');
% 
% % Plot
