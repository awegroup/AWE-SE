%% Design space exploraton: 500 kW: Decreased Kite mass
...
% Load input file
inputs = loadInputs('inputFile_500kW_decr_mk.yml');

% Define range for wing area 
WA_values = [60, 70, 80]; % m^2
...
save('outPutFiles/designSpace_500kW_WA_WL_var_decr_mk.mat', 'designSpace_500kW_WA_WL_var');

% Load saved design space results
load('outPutFiles/designSpace_500kW_WA_WL_var_decr_mk.mat');
...
% Save design space results
save('outPutFiles/designSpace_500kW_WL_sigma_t_var_decr_mk.mat','designSpace_500kW_WL_sigma_t_var');

% Load the saved design space results
load('outPutFiles/designSpace_500kW_WL_sigma_t_var_decr_mk.mat');
...
% Save design space results
save('outPutFiles/designSpace_500kW_WA_AR_var_decr_mk.mat','designSpace_500kW_WA_AR_var');

% Load the saved design space results
load('outPutFiles/designSpace_500kW_WA_AR_var_decr_mk.mat');
...
% Save design space results
save('outPutFiles/designSpace_500kW_WA_crestFactor_var_decr_mk.mat','designSpace_500kW_WA_crestFactor_var');

% Load the saved design space results
load('outPutFiles/designSpace_500kW_WA_crestFactor_var_decr_mk.mat');
...
clearvars
perfInputs = loadInputs('inputFile_500kW_decr_mk.yml');
...
save('outputFiles/systemData_500kW_decr_mk.mat');
