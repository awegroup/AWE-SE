%% Design space exploraton: 500 kW No storage costs
...
% Load input file
inputs = loadInputs('inputFile_500kW_noStorage.yml');
...
save('outPutFiles/designSpace_500kW_WA_WL_var_noStorage.mat', 'designSpace_500kW_WA_WL_var');

% Load saved design space results
load('outPutFiles/designSpace_500kW_WA_WL_var_noStorage.mat');
...
% Save design space results
save('outPutFiles/designSpace_500kW_WL_sigma_t_var_noStorage.mat','designSpace_500kW_WL_sigma_t_var');

% Load the saved design space results
load('outPutFiles/designSpace_500kW_WL_sigma_t_var_noStorage.mat');
...
% Save design space results
save('outPutFiles/designSpace_500kW_WA_AR_var_noStorage.mat','designSpace_500kW_WA_AR_var');

% Load the saved design space results
load('outPutFiles/designSpace_500kW_WA_AR_var_noStorage.mat');
...
% Save design space results
save('outPutFiles/designSpace_500kW_WA_crestFactor_var_noStorage.mat','designSpace_500kW_WA_crestFactor_var');

% Load the saved design space results
load('outPutFiles/designSpace_500kW_WA_crestFactor_var_noStorage.mat');
...
clearvars
perfInputs = loadInputs('inputFile_500kW_noStorage.yml');
...
save('outputFiles/systemData_500kW_noStorage.mat');
