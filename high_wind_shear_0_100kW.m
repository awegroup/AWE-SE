%% Design space exploraton: 100 kW 0 Wind Shear and 10 m/s wind speed
...
% Load input file
inputs = loadInputs('inputFile_100kW_high_wind_0_shear.yml');
...
save('outPutFiles/designSpace_100kW_WA_WL_var_high_wind_0_shear.mat', 'designSpace_100kW_WA_WL_var');

% Load saved design space results
load('outPutFiles/designSpace_100kW_WA_WL_var_high_wind_0_shear.mat');
...
% Save design space results
save('outPutFiles/designSpace_100kW_WL_sigma_t_var_high_wind_0_shear.mat','designSpace_100kW_WL_sigma_t_var');

% Load the saved design space results
load('outPutFiles/designSpace_100kW_WL_sigma_t_var_high_wind_0_shear.mat');
...
% Save design space results
save('outPutFiles/designSpace_100kW_WA_AR_var_high_wind_0_shear.mat','designSpace_100kW_WA_AR_var');

% Load the saved design space results
load('outPutFiles/designSpace_100kW_WA_AR_var_high_wind_0_shear.mat');
...
% Save design space results
save('outPutFiles/designSpace_100kW_WA_crestFactor_var_high_wind_0_shear.mat','designSpace_100kW_WA_crestFactor_var');

% Load the saved design space results
load('outPutFiles/designSpace_100kW_WA_crestFactor_var_high_wind_0_shear.mat');
...
perfInputs = loadInputs('inputFile_100kW_high_wind_0_shear.yml');
...
save('outputFiles/systemData_100kW_high_wind_0_shear.mat');
