%% Design space exploraton: 100 kW No storage costs
...
% Load input file
inputs = loadInputs('inputFile_100kW_noStorage.yml');
...
save('outPutFiles/designSpace_100kW_WA_WL_var_noStorage.mat', 'designSpace_100kW_WA_WL_var');

% Load saved design space results
load('outPutFiles/designSpace_100kW_WA_WL_var_noStorage.mat');
...
% Save design space results
save('outPutFiles/designSpace_100kW_WL_sigma_t_var_noStorage.mat','designSpace_100kW_WL_sigma_t_var');

% Load the saved design space results
load('outPutFiles/designSpace_100kW_WL_sigma_t_var_noStorage.mat');
...
% Save design space results
save('outPutFiles/designSpace_100kW_WA_AR_var_noStorage.mat','designSpace_100kW_WA_AR_var');

% Load the saved design space results
load('outPutFiles/designSpace_100kW_WA_AR_var_noStorage.mat');
...
% Save design space results
save('outPutFiles/designSpace_100kW_WA_crestFactor_var_noStorage.mat','designSpace_100kW_WA_crestFactor_var');

% Load the saved design space results
load('outPutFiles/designSpace_100kW_WA_crestFactor_var_noStorage.mat');
...
perfInputs = loadInputs('inputFile_100kW_noStorage.yml');
...
save('outputFiles/systemData_100kW_noStorage.mat');
