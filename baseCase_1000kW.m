%% Design space exploraton: 1000 kW Base case
clc; clearvars;
...
save('outPutFiles/designSpace_1000kW_WA_WL_var_baseCase.mat', 'designSpace_1000kW_WA_WL_var');

% Load saved design space results
load('outPutFiles/designSpace_1000kW_WA_WL_var_baseCase.mat');
...
% Save design space results
save('outPutFiles/designSpace_1000kW_WL_sigma_t_var_baseCase.mat','designSpace_1000kW_WL_sigma_t_var');

% Load the saved design space results
load('outPutFiles/designSpace_1000kW_WL_sigma_t_var_baseCase.mat');
...
% Save design space results
save('outPutFiles/designSpace_1000kW_WA_AR_var_baseCase.mat','designSpace_1000kW_WA_AR_var');

% Load the saved design space results
load('outPutFiles/designSpace_1000kW_WA_AR_var_baseCase.mat');
...
% Save design space results
save('outPutFiles/designSpace_1000kW_WA_crestFactor_var_baseCase.mat','designSpace_1000kW_WA_crestFactor_var');

% Load the saved design space results
load('outPutFiles/designSpace_1000kW_WA_crestFactor_var_baseCase.mat');
...
save('outputFiles/systemData_1000kW_baseCase.mat');
