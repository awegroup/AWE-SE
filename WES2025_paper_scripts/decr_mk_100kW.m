%% Design space exploraton: 100 kW: Decreased kite mass
...
save('outPutFiles/designSpace_100kW_WA_WL_var_decr_mk.mat', 'designSpace_100kW_WA_WL_var');

% Load saved design space results
load('outPutFiles/designSpace_100kW_WA_WL_var_decr_mk.mat');
...
% Save design space results
save('outPutFiles/designSpace_100kW_WL_sigma_t_var_decr_mk.mat','designSpace_100kW_WL_sigma_t_var');

% Load the saved design space results
load('outPutFiles/designSpace_100kW_WL_sigma_t_var_decr_mk.mat');
...
% Save design space results
save('outPutFiles/designSpace_100kW_WA_AR_var_decr_mk.mat','designSpace_100kW_WA_AR_var');

% Load the saved design space results
load('outPutFiles/designSpace_100kW_WA_AR_var_decr_mk.mat');
...
% Save design space results
save('outPutFiles/designSpace_100kW_WA_crestFactor_var_decr_mk.mat','designSpace_100kW_WA_crestFactor_var');

% Load the saved design space results
load('outPutFiles/designSpace_100kW_WA_crestFactor_var_decr_mk.mat');
...
perfInputs = loadInputs('inputFile_100kW_decr_mk.yml');
...
save('outputFiles/systemData_100kW_decr_mk.mat');
