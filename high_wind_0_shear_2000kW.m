%% Design space exploraton: 2000 kW Wind Shear and 10m/s wind speed
...
% Load input file
inputs = loadInputs('inputFile_2000kW_high_wind_0_shear.yml');

% Define range for wing area 
WA_values = [120, 130, 140]; % m^2

% Define range for wing loading
WL_values = [4e3, 5e3, 6e3]; % N/m^2
...
save('outPutFiles/designSpace_2000kW_WA_WL_var_high_wind_0_shear.mat', 'designSpace_2000kW_WA_WL_var');

% Load saved design space results
load('outPutFiles/designSpace_2000kW_WA_WL_var_high_wind_0_shear.mat');
...
% Save design space results
save('outPutFiles/designSpace_2000kW_WL_sigma_t_var_high_wind_0_shear.mat','designSpace_2000kW_WL_sigma_t_var');

% Load the saved design space results
load('outPutFiles/designSpace_2000kW_WL_sigma_t_var_high_wind_0_shear.mat');
...
% Save design space results
save('outPutFiles/designSpace_2000kW_WA_AR_var_high_wind_0_shear.mat','designSpace_2000kW_WA_AR_var');

% Load the saved design space results
load('outPutFiles/designSpace_2000kW_WA_AR_var_high_wind_0_shear.mat');
...
% Save design space results
save('outPutFiles/designSpace_2000kW_WA_crestFactor_var_high_wind_0_shear.mat','designSpace_2000kW_WA_crestFactor_var');

% Load the saved design space results
load('outPutFiles/designSpace_2000kW_WA_crestFactor_var_high_wind_0_shear.mat');
...
perfInputs = loadInputs('inputFile_2000kW_high_wind_0_shear.yml');
...
save('outputFiles/systemData_2000kW_high_wind_0_shear.mat');
...
% 
% % Save design space results
% save('outPutFiles/designSpace_2000kW_crestFactor_P_rated_var_high_wind_0_shear.mat','designSpace_2000kW_crestFactor_P_rated_var');
% 
% % Load the saved design space results
% load('outPutFiles/designSpace_2000kW_crestFactor_P_rated_var_high_wind_0_shear.mat');
% 
% % Plot
